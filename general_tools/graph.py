...
logger = logging.getLogger("general_tools.graph")
...
RELATION_VOCAB = {
    ...
    "introduces", "surveys", "exemplifies", "founds", "addresses",
}
...
class KnowledgeGraph:
    ...
    # ── Analytics ─────────────────────────────────────────────────────────
    def clear(self) -> None:
        """Remove all nodes and edges in place (used to switch note projects)."""
        self._nodes.clear()
        self._edges.clear()
