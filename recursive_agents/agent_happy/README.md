# agent_happy — The FIRST Recursive Agent, Level 1
...
| | |
|:---|:---|
| **Agent** | `agent_happy` (level 1) |
| **Engine** | `agent_happy/agent_happy_engine/` — Copilot-level engine with hooks, prompt assembler, autopilot, summarizer |
| **Tools** | `agent_happy/agent_happy_tools/` — **74 tools** in 15 categories |
...
## Tools — `agent_happy_tools/` (74 tools)
