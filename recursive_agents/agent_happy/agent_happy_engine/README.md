# agent_happy_engine — Level 1 Recursive Agent Engine
...
| **Engine location** | `recursive_agents/agent_happy/agent_happy_engine/` |
...
(`recursive_agents/agent_happy/agent_happy_tools`).

## IPP Files

- `IPP.json` — the F-file (node_id `agent_happy_engine`), ports, guardrails
