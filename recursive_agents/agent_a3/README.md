# agent_a3 — The FIRST Recursive Agent, Level 3
...
| **Engine** | `agent_a3/agent_a3_engine/` — Copilot-level engine with hooks, prompt assembler, autopilot, summarizer |
| **Tools** | `agent_a3/agent_a3_tools/` — **74 tools** in 15 categories |
...
## Verification Checklist (agent_a3 must pass ALL)
