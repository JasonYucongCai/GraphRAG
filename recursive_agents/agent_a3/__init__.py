"""
agent_a3 — the FIRST recursive agent of the self-adaptive chain, level 3.

Constructed strictly per IPP v0.2.8. This is the FIRST COMPILATION —
the agent whose tools CREATE agent_a3, which then creates agent_a3.

Architecture:
  agent_a3_engine/  — Enhanced engine (hooks, prompt assembler, autopilot, summarizer)
  agent_a3_tools/   — 74 tools in 15 categories including the agent-construction suite
