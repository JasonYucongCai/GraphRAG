# agent_a2_engine — Level 2 Recursive Agent Engine
...
| **Engine location** | `recursive_agents/agent_a2/agent_a2_engine/` |
...
(`recursive_agents/agent_a2/agent_a2_tools`).

## IPP Files

- `IPP.json` — the F-file (node_id `agent_a2_engine`), ports, guardrails
