"""
agent_a2 — the FIRST recursive agent of the self-adaptive chain, level 2.
...
Architecture:
  agent_a2_engine/  — Enhanced engine (hooks, prompt assembler, autopilot, summarizer)
  agent_a2_tools/   — 74 tools in 15 categories including the agent-construction suite
