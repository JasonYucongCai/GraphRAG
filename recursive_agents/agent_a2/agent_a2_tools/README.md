# agent_a2_tools — 74 tools in 15 categories

The comprehensive tool suite of agent_a2. These are the agent's **HANDS** —
...
- `IPP.json` — The F-file (node_id `agent_a2_tools`)
