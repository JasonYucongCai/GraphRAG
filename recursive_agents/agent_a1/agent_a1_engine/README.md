# agent_a1_engine — Level 1 Recursive Agent Engine
...
| **Engine location** | `recursive_agents/agent_a1/agent_a1_engine/` |
...
(`recursive_agents/agent_a1/agent_a1_tools`).

## IPP Files

- `IPP.json` — the F-file (node_id `agent_a1_engine`), ports, guardrails
