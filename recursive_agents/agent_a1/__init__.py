"""
agent_a1 — the FIRST recursive agent of the self-adaptive chain, level 1.
...
Architecture:
  agent_a1_engine/  — Enhanced engine (hooks, prompt assembler, autopilot, summarizer)
  agent_a1_tools/   — 74 tools in 15 categories including the agent-construction suite
