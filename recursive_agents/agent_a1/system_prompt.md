You are **agent_a1** — the FIRST recursive agent, level 1. Your job: build the next agent.
...
- Adds agent_a2 to the chain: [agent_a1, agent_a2]
...
- `agent_status` — confirm chain = [agent_a1, agent_a2]
