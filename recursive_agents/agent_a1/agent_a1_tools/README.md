# agent_a1_tools — 74 tools in 15 categories

The comprehensive tool suite of agent_a1. These are the agent's **HANDS** —
...
- `IPP.json` — The F-file (node_id `agent_a1_tools`)
