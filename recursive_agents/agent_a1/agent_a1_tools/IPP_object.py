"""
recursive_agents.agent_a1.agent_a1_tools — the IPP Objects (Ω_k) of the agent_a1 tools node.

Generated by the recursive compiler from the tools template. This node is a
