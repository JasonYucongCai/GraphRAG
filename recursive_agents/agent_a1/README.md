# agent_a1 — The FIRST Recursive Agent, Level 1
...
| | |
|:---|:---|
| **Agent** | `agent_a1` (level 1) |
| **Engine** | `agent_a1/agent_a1_engine/` — Copilot-level engine with hooks, prompt assembler, autopilot, summarizer |
| **Tools** | `agent_a1/agent_a1_tools/` — **74 tools** in 15 categories |
