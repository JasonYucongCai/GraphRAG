...
Keeps the legacy tools.IPP (IPP v0.1 abstraction + ToolRegistry) intact —
this module adds the v0.2.8 runtime (ipp/) on top.
"""
...
logger = logging.getLogger("tools.IPP_runtime")
...
def tool_node(agent_id: str = "codex_normal",
    ...
    from tools.agent_specs import tool_set, chat_tool_set
