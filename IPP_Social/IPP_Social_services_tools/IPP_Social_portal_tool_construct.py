...
Γ ⊩ IPP_Social_portal_tool_ipp.json × 𝒢 ↝ the portal IPP node with four channels
...
from IPP_Social.IPP_Social_services_tools.IPP_Social_portal_tool_executor import PortalExecutor

_IPP_JSON = Path(__file__).resolve().parent / "IPP_Social_portal_tool_ipp.json"
