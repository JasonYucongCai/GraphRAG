"""
codex_growth.engine.IPP_executor — the IPP Executors (Ξ_k) of the growth engine.

Agent-specific audit extras: trace length and tool-call count are recorded
into the hash-chained audit record (before hashing).
"""
